...
def _sidebar_link(spec: PageSpec, label: str, css_class: str) -> str:
...
.brand-block{
  ...
  border:1px solid rgba(29,165,57,.18);
  border-radius:14px;
  background:linear-gradient(135deg,#F1FBF3,#FFFFFF);
  box-shadow:0 10px 24px rgba(29,165,57,.08);
}
.brand-icon{
  font-size:44px;
  line-height:1;
  color:#3DBD57;
  flex:0 0 44px;
  filter:drop-shadow(0 2px 2px rgba(29,165,57,.18));
}
.brand-kicker{
  font-size:14px;
  font-weight:900;
