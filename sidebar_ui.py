...
def _link(spec: PageSpec, label: str, css_class: str) -> str:
    ...
    styles = {
        "nav-section": (
            "font-size:23px!important;font-weight:950!important;margin:25px 0 13px 0;"
            "padding:6px 0;color:#0f172a;"
        ),
        "nav-child": (
            "font-size:18px!important;font-weight:850!important;margin:0 0 13px 30px;"
            "padding:6px 6px;color:#0f172a;"
        ),
        "nav-root": (
            "font-size:19px!important;font-weight:850!important;margin:0 0 25px 0;"
            "padding:8px 8px;color:#0f172a;"
        ),
    }
    text_sizes = {"nav-section": 23, "nav-child": 18, "nav-root": 19}
    icon_sizes = {"nav-section": 29, "nav-child": 23, "nav-root": 24}
...
def render_sidebar(page_sections: Sequence[SectionSpec]) -> None:
    css = [
        ...
        ".brand-block{display:flex;align-items:center;justify-content:center;gap:16px;margin:-2px 0 22px 0;padding:10px 4px 12px 4px;border:0;background:transparent;box-shadow:none;}",
        ".brand-icon{font-size:52px;line-height:1;color:#1DA539;flex:0 0 52px;filter:drop-shadow(0 2px 2px rgba(29,165,57,.18));}",
        ".brand-kicker{font-size:16px;font-weight:900;line-height:1.1;color:#334155;letter-spacing:.2px;text-align:left;}",
        ".brand-title{font-size:38px;font-weight:950;line-height:1.02;color:#0f172a;letter-spacing:.6px;margin-top:5px;text-align:left;}",
        ".brand-subtitle{font-size:18px;font-weight:900;line-height:1.1;color:#334155;margin-top:6px;letter-spacing:.2px;text-align:left;}",
