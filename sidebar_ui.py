...
def render_sidebar(page_sections: Sequence[SectionSpec]) -> None:
    css = [
        ...
        ".brand-block{display:flex;align-items:center;gap:14px;margin:0 0 24px 0;padding:8px 6px 14px 6px;border:0;border-bottom:4px solid #1DA539;background:transparent;box-shadow:none;}",
        ".brand-icon{font-size:46px;line-height:1;color:#1DA539;flex:0 0 46px;filter:drop-shadow(0 2px 2px rgba(29,165,57,.22));}",
        ".brand-kicker{font-size:14px;font-weight:900;line-height:1.1;color:#1DA539;letter-spacing:.3px;}",
        ".brand-title{font-size:31px;font-weight:950;line-height:1.02;color:#0f172a;letter-spacing:.8px;margin-top:5px;}",
        ".brand-subtitle{font-size:16px;font-weight:900;line-height:1.1;color:#1DA539;margin-top:6px;letter-spacing:.4px;}",
