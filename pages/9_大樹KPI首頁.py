...
ALLOW_PAGES = {
    "app_pages/10_進貨驗收量.py",
    "app_pages/11_庫存訂單應出量分析.py",
    "app_pages/12_越庫訂單分析.py",
    "app_pages/13_庫存訂單實出量分析.py",
    "app_pages/14_每日上架分析.py",
    "app_pages/15_庫存盤點正確率.py",
    "app_pages/16_門市到貨異常率.py",
    "app_pages/18_儲位使用率.py",  # ✅ 新增入口
}
