...
def render_sidebar() -> None:
    css = [
        ...
        ".nav-root{margin:0 0 18px 0;}",
        ".nav-root div[data-testid='stPageLink'] a{font-weight:850!important;font-size:16px!important;padding:6px 8px!important;}",
        ".nav-section{margin:20px 0 8px 0;}",
        ".nav-section div[data-testid='stPageLink'] a{font-weight:850!important;font-size:15px!important;color:#cde4fb!important;padding:3px 0!important;background:transparent!important;}",
        ".nav-section div[data-testid='stPageLink'] a[aria-current='page']{background:transparent!important;}",
        ".nav-child{margin-left:25px;margin-bottom:10px;}",
        ".nav-child div[data-testid='stPageLink'] a{font-weight:950!important;font-size:17px!important;line-height:1.2!important;padding:5px 6px!important;}",
